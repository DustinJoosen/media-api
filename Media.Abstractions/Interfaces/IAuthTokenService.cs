...
namespace Media.Abstractions.Interfaces
{
    public interface IAuthTokenService
    {
        ...
        Task<CreateTokenResponse> CreateToken(CreateTokenRequest tokenReq, CancellationToken cancellationToken = default);
        ...
        Task<FindTokenInfoResponse> FindTokenInfo(string token, CancellationToken cancellationToken = default);
        ...
        Task<AuthTokenPermissions> GetRoles(string token, CancellationToken cancellationToken = default);
        ...
        Task ChangePermissions(ChangeTokenPermissionRequest changeTokenPermissionReq, string token, CancellationToken cancellationToken = default);
    }
}
