...
namespace Media.Presentation.Controllers
{
	...
	public class TokenController : ControllerBase
	{
		...
		/// <summary>
		/// Finds information about an authorization token; 
		/// the Expiration date and whether the token is active.
		/// </summary>
		[HttpGet]
		[Route("info")]
		[TokenRequired]
		...
		/// <summary>
		/// Changes permissions of an authorization token. 
		/// Note that this action requires a token with the CanManagePermissions permission.
		/// </summary>
		[HttpPut]
			...
			CancellationToken cancellationToken = default)
		{
			...
			return this.Ok($"Token has been given new permissions.");
		}

		/// <summary>
		/// Deactivate an authorization token. 
		/// It will remain in the database, but it can't be used any longer.
		/// </summary>
		[HttpDelete]
